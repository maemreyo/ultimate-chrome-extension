// Enhanced hook with multi-provider support and new capabilities
...
export function useAI(options?: UseAIOptions) {
  ...
  const generateText = useCallback(
    async (prompt: string, genOptions?: GenerateOptions) => {
      setLoading(true)
      setError(null)
  ...
  const generateStream = useCallback(
    async function* (prompt: string, genOptions?: GenerateOptions) {
      setLoading(true)
      setError(null)
  ...
  const summarize = useCallback(
    async (text: string, sumOptions?: SummarizeOptions) => {
      setLoading(true)
      setError(null)
  ...
  const generateImage = useCallback(
    async (prompt: string, imgOptions?: ImageGenerationOptions) => {
      setLoading(true)
      setError(null)
  ...
  const analyzeImage = useCallback(
    async (image: string | Blob, analysisOptions?: any) => {
      setLoading(true)
      setError(null)
  ...
  const transcribeAudio = useCallback(
    async (audio: Blob, transcriptionOptions?: TranscriptionOptions) => {
      setLoading(true)
      setError(null)
  ...
  const generateCode = useCallback(
    async (prompt: string, codeOptions?: CodeGenerationOptions) => {
      setLoading(true)
      setError(null)
